...
def main():
    ...
    for test_case in test_cases:
        ...
        output_file = os.path.join(output_dir, f"pdfplumber_results_{len(evaluation_results)}.txt")
    ...
    summary_file = os.path.join(output_dir, "pdfplumber_evaluation_summary.json")
